...
import 'package:my_chat_app/pickers/graduation_picker.dart';
    ...
    return Consumer<ProfileProvider>(builder: (context, profileProvider, _) {
      return Row(
        children: [
          ...
          Text(graduationPicker[profileProvider.myProfile.graduation] ?? '',
                          ...
                          Container(
                            ...
                            child: CupertinoPicker(
                              ...
                              onSelectedItemChanged: (int index) =>
                                  profileProvider.myProfile.graduation =
                                      graduationPicker.keys.elementAt(index),
                            ),
                          )
                        ],
                      ),
